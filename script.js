//API 8a47480df282a939ef418d2dc0acaef2
...
function initPage() {
  ...
  // white object to the console
  console.log(searchHistory);
  // APIkey
  var APIKey = "8a47480df282a939ef418d2dc0acaef2";

  //  When search button is clicked, read the city name typed by the user
  function getWeather(cityName) {
//  Using saved city name, execute a current condition get request from open weather map api
      var queryURL = "https://api.openweathermap.org/data/2.5/weather?q=" + cityName + "&appid=" + APIKey;
      // gets the url and returns a promiss 
      axios.get(queryURL)
...
//  Date method - https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Date
          ...
          var month = currentDate.getMonth() + 1; // January gives 0
